...
import { TrendingUp, TrendingDown, DollarSign, AlertCircle, BarChart2, Calendar, Award } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard 
          ...
          subtitle={`${Math.round((summary.total_loss / summary.total_revenue) * 100) || 0}% de ing.`}
        />
        <StatCard 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <ProductTable products={products.top_5} />

        {/* DETALLES DE PÉRDIDAS Y BAJA ROTACIÓN */}
